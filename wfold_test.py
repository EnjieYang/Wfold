...
from wfold.utils import *
from wfold.config import process_config
import pdb
import time
from wfold.data_generator import RNASSDataGenerator, Dataset
#from wfold.data_generator import Dataset_Cut_concat_new as Dataset_FCN
from wfold.data_generator import Dataset_Cut_concat_new_canonicle as Dataset_FCN
from wfold.data_generator import Dataset_Cut_concat_new_merge_two as Dataset_FCN_merge
import collections

args = get_args()
if args.nc:
    from wfold.postprocess import postprocess_new_nc as postprocess
else:
    from wfold.postprocess import postprocess_new as postprocess
...
##      add fine tune
    ...
    #with open('/data2/darren/experiment/wfold/results/sample_result.pickle','wb') as f:
...
def main():
    ...
    #MODEL_SAVED = '/data2/darren/experiment/wfold/models_ckpt/unet30.pt'
    #MODEL_SAVED = '/data2/darren/experiment/wfold/models_ckpt/unet_reduce_noupscale25.pt'
    #MODEL_SAVED = '/data2/darren/experiment/wfold/models_ckpt/unet_reduce15.pt'
    #MODEL_SAVED = '/data2/darren/experiment/wfold/models_ckpt/unet_rfam12_noupscale90.pt'
    #MODEL_SAVED = '/data2/darren/experiment/wfold/models_ckpt/unet_rfam12_noupscale_simfam90.pt'
    #MODEL_SAVED = '/data2/darren/experiment/wfold/models_ckpt/unet_rfam12_upscale7fam_90.pt'
    #MODEL_SAVED = '/data2/darren/experiment/wfold/models_ckpt/unet_bpTR0_addsimmutate_ori49.pt'
    #MODEL_SAVED = '/data2/darren/experiment/wfold/models_ckpt/unet_bpTR0_addsimmutate_8dim49.pt'
    #MODEL_SAVED = '/data2/darren/experiment/wfold/models_ckpt/unet_bpTR0_addsimmutate_addmoresimilar17.pt' #unet_bpTR0_addsimmutate_addmoresimilar48.pt
    #MODEL_SAVED = '/data2/darren/experiment/wfold/models_ckpt/final_model/unet_train_on_TR0_33.pt'
    #MODEL_SAVED = '/data2/darren/experiment/wfold/models_ckpt/final_model/unet_train_on_RNAlign_49.pt'
    if test_file not in ['TS1','TS2','TS3']:
        MODEL_SAVED = 'models/wfold_train.pt'    
    else:
        MODEL_SAVED = 'models/wfold_train_pdbfinetune.pt'
    #MODEL_SAVED = '/data2/darren/experiment/wfold/models_ckpt/final_model/unet_train_on_TR0andMXUnet_99.pt'
    #MODEL_SAVED = '/data2/darren/experiment/wfold/models_ckpt/final_model/unet_train_on_TR0bpnewOriuseMXUnet_96.pt'
    #MODEL_SAVED = '/data2/darren/experiment/wfold/models_ckpt/final_model/unet_train_on_TR0_extract_99.pt'
    #MODEL_SAVED = '/data2/darren/experiment/wfold/models_ckpt/final_model/unet_train_on_TR0_continuefrom99_56.pt'
    #MODEL_SAVED = '/data2/darren/experiment/wfold/models_ckpt/unet_bpTR0_addsimmutate_addmoresimilar_finetune0.pt'
    #MODEL_SAVED = '/data2/darren/experiment/wfold/models_ckpt/unet_bpTR0_addsimmutate_addmoresimilar_twochannel48.pt'
    #MODEL_SAVED = '/data2/darren/experiment/wfold/models_ckpt/unet_bpTR0_addsimmutate_addmoresimilar_25dim46.pt'
    #MODEL_SAVED = '/data2/darren/experiment/models_ckpt/concat_trainsetA/unet_trainsetA14.pt'
    #MODEL_SAVED = '/data2/darren/experiment/wfold/models_ckpt/unet_rfam12_upscaleonlyPDB_outer7.pt'
    #MODEL_SAVED = '/data2/darren/experiment/wfold/models_ckpt/unet_rfam12_upscaleallfams_19.ptunet_rfam12_upscaleonlyPDB_finetune8.pt'
    #MODEL_SAVED = '/data2/darren/experiment/models_ckpt/concat/'
    #MODEL_SAVED = '/data2/darren/experiment/wfold/models_ckpt/unet_bpRNA26.pt'
    #MODEL_SAVED = '/data2/darren/experiment/wfold/models_ckpt/unet48.pt'
    ...
    model_path = '/data2/darren/experiment/wfold/models_ckpt/'.format(model_type, data_type,d)
    ...
    #test_data = RNASSDataGenerator('/data2/darren/experiment/wfold/data/rnastralign_all/', 'test_no_redundant.pickle')
    #test_data = RNASSDataGenerator('/data2/darren/experiment/wfold/data/rnastralign_all/', 'test_no_redundant_600.pickle')
    ...
    #test_data = RNASSDataGenerator('/data2/darren/experiment/wfold/data/', 'all_1800_archieveII.pickle')
    #test_data = RNASSDataGenerator('/data2/darren/experiment/wfold/data/', 'all_600_archieveII.pickle')
    #test_data = RNASSDataGenerator('/data2/darren/experiment/wfold/data/', 'bpRNA12_test_generate.cPickle')
    #test_data = RNASSDataGenerator('/data2/darren/experiment/wfold/data/', 'bpRNA12_RF00001_similarfamilys_test.cPickle')
    #test_data = RNASSDataGenerator('/data2/darren/experiment/wfold/data/', 'bpRNA_TestSetA.cPickle')
    #test_data = RNASSDataGenerator('/data2/darren/experiment/wfold/data/', 'bpRNA12_allfamily_generate_test.cPickle')
    #test_data = RNASSDataGenerator('/data2/darren/experiment/wfold/data/', 'bpRNA12_38family_generate_test.cPickle')
    ##test_data = RNASSDataGenerator('/data2/darren/experiment/wfold/data/', 'bpRNA_new_generate.cPickle')
    #test_data = RNASSDataGenerator('/data2/darren/experiment/wfold/data/', 'bpRNA_new20201015.cPickle')
    #test_data = RNASSDataGenerator('/data2/darren/experiment/wfold/data/', 'archieveII_contacts_pred.cPickle')
    #test_data = RNASSDataGenerator('/data2/darren/experiment/wfold/data/', 'bpRNA_pdbnewgenerate_yingxc.cPickle')
    #test_data = RNASSDataGenerator('/data2/darren/experiment/wfold/data/', 'bpRNA_TS0_ori.cPickle')
    #test_data = RNASSDataGenerator('/data2/darren/experiment/wfold/data/', 'bpRNA_TR0_leavefortest1000.cPickle')
    #test_data = RNASSDataGenerator('/data2/darren/experiment/wfold/data/', 'bpRNA_TR0_andsim_mutate_extract_train.cPickle')
