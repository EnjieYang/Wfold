...
#from wfold.data_generator import Dataset_Cut_concat_new_merge as Dataset_FCN_merge
from wfold.data_generator import Dataset_Cut_concat_new_merge_multi as Dataset_FCN_merge
import collections
...
def train(contact_net,train_merge_generator,epoches_first):
    ...
    # test_script()
    #t1 = subprocess.getstatusoutput('awk \'{if($1 ~ /^>/)print}\' /data2/darren/experiment/wfold/data/rnastralign_all/rnastralign_train_no_redundant.seq.cdhit')
    ...
    for epoch in range(epoches_first):
        ...
        if epoch > -1:
            ...
            torch.save(contact_net.state_dict(),  f'../models_ckpt/final_model/for_servermodel/tmp/wfold_train_onalldata_{epoch}.pt')
...
def main():
    ...
    test_data_archive = RNASSDataGenerator('/data2/darren/experiment/wfold/data/', 'test_600.pickle')
    test_data_TS0 = RNASSDataGenerator('/data2/darren/experiment/wfold/data/', 'bpRNA_TS0_ori.cPickle')
    test_data_bpnew = RNASSDataGenerator('/data2/darren/experiment/wfold/data/', 'bpRNA_new20201015.cPickle')
    test_data_TS1 = RNASSDataGenerator('/data2/darren/experiment/wfold/data/', 'bpRNA_TS1_test_new.cPickle')
    test_data_TS2 = RNASSDataGenerator('/data2/darren/experiment/wfold/data/', 'bpRNA_TS3_test.cPickle')
    test_data_TS3 = RNASSDataGenerator('/data2/darren/experiment/wfold/data/', 'bpRNA_TS2_test.cPickle')
